...
export const metadata: Metadata = {
  ...
  description: "Contact ByteBoom — support, partnerships, and general inquiries about our crypto trading engine.",
};
