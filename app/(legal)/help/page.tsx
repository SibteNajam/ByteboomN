...
export const metadata: Metadata = {
  ...
  description: "ByteBoom Help Center — answers about Binance API setup, bot configuration, billing, and troubleshooting.",
};
