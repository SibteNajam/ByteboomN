...
export const metadata: Metadata = {
  ...
  description: "ByteBoom changelog — product updates, new trading engine features, and platform improvements.",
};
