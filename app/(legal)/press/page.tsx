...
export const metadata: Metadata = {
  ...
  description: "ByteBoom press kit — brand assets, company overview, and media contact for our crypto trading engine.",
};
