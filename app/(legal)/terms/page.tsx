...
export const metadata: Metadata = {
  ...
  description: "ByteBoom Terms of Service — rules for using our automated crypto trading engine and platform.",
};
