/** Trading Journey — five docks (same behavior as newapp).
    Live phone scales slightly; ghosts stay faintly visible.
    Pass 1 = 1–5; pass 2 = 6–8 (right docks empty).
    Speech uses this project's cloud bubble (not the newapp box).
          ...
          <div className="bbj-wrap">
            <header className="bbj-head">
              ...
              <p className="sec-lede">
                Open app → signals &amp; demo → subscribe → connect Binance → activate → unlink or
                delete when you choose.
              </p>
            </header>
