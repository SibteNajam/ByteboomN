/** Server-rendered 3D shell — outside client components so stations.js can inject canvas without hydration errors. */
export default function WorldLayerShell() {
  return (
    <>
      <div id="stage" aria-hidden="true" />
      <div id="veil" aria-hidden="true" />
      <div id="depth" aria-hidden="true" />
      <div id="routemap" aria-hidden="true">
        ...
        <svg width="60" height="150" viewBox="0 0 60 150">
          ...
          <polyline
            className="trail"
            points="30,8 48,30 12,52 48,74 12,96 40,116 20,134 30,146"
          />
          <polyline
            id="litpath"
            className="lit"
